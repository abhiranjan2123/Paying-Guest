     ...
     <div className="flex max-w-4xl m-4 flex-1 flex-col justify-center px-14 py-10 lg:px-8 md:px-28 shadow-md bg-glassy rounded-3xl">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            ...
            <div>
              <label htmlFor="user_phone" className="block text-sm/6 font-medium text-gray-900">
                Phone number
              </label>
              <div className="mt-1">
                <input
            ...
            <div>
              <label htmlFor="booking_date" className="block text-sm/6 font-medium text-gray-900">
              Visit Date and Time
              </label>
              <div className="mt-2">
                <input
